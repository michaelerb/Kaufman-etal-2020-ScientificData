...
tas_recent_decade = 1.05 + 0.03; label_txt = 'HadCRUT5'  # This is a value from HadCRUT5 (1.05) plot a 0.03 differential to account for the different reference periods
